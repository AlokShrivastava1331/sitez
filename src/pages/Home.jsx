          ...
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-black md:w-full'>
              <h1 className='text-4xl leading-tight text-black font-semibold'>
                Navigate Your<br /> Path to the <br />Dream College
              </h1>
              <h3 className='text-lg mt-3'>Unlock Your Potential with Expert College Guidance</h3>
              <span className='text-[14px]'>Get best carrer Guidance with minimum price.</span>
              <br/>
              <br/>
            ...
            <div className='right w-1/2 md:w-full relative'>
              ...
              <div className='content'>
                ...
                <button className='bg-white shadow-md absolute top-56 -right-32 z-30 p-2  md:top-96 md:-right-5 flex items-center rounded-md'>
                  ...
                  <div className='text flex flex-col items-start px-4'>
                    <span className='text-sm text-black'>best carrer Guidance</span>
                    <span className='text-[12px]'>with minimum price</span>
                  </div>
                </button>
                <button className='bg-white shadow-md absolute left-0 top-12 z-30 p-2 flex items-center rounded-md'>
